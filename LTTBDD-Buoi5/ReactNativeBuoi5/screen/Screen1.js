...
export default function Screen1() {
  ...
  const btnMua = () => {
    var mau = "";
    if (img == "/static/media/vs_silver.a64810c71fe2bda8952f.png") mau = "Bạc";
    else if (img == "/static/media/vs_blue.6f9fdf8955497b5153d5.png")
      mau = "Xanh dương";
    else if (img == "/static/media/vs_red.0ba29d74ac59ed89211a.png") mau = "Đỏ";
    ...
    >
      <View style={{}}>
        ...
        <Text style={{ fontWeight: "bold", fontSize: 16 }}>
          Điện thoại Vsamrt Joy 3 - hàng chính hãng
        </Text>
      </View>
      <View
        style={{
      ...
      <View style={{ marginBottom: 20, flexDirection: "row", width: "90%" }}>
        ...
        <Text style={{ fontSize: 12, color: "grey", marginLeft: 90 }}>
          1.790.000 đ
        </Text>
      </View>
      <View style={{ width: "90%" }}>
